...
const app = new Hono()
    ...
    .patch(
            ...
            async (c)=>{
                ...
                const exisitingProjects = await databases.getDocument<Project>(
                    DATABASE_ID,
                    PROJECTS_ID,
                    projectId
                )
                ...
                const member = await getMember({
                    databases,
                    workspaceId: exisitingProjects.workspaceId,
                    userId : user.$id
                })
    ...
    .delete(
            ...
            async(c)=>{
                ...
                //TODO: Delete Memebr,projects and Tasks
                ...
                return c.json({data: {$id : exisitingProjects.$id}})
            }
    )
    .get(
        "/:projectId/analytics",
        ...
        async (c) =>{
            ...
            const assigneedTaskCount = thisMonthAssigneedTasks.total;
            const assigneedTaskDifference = assigneedTaskCount-lastMonthAssigneedTasks.total;
